...
def plot_training_metrics(history, string):
...
plot_training_metrics(history, "Accuracy_Loss_Over_Epochs.png")
...
# Confusion Matrix
cm_train = confusion_matrix(y_train, y_pred_classes_train)
cm_test = confusion_matrix(y_test, y_pred_classes)

# Plot confusion matrix for train data
plt.figure(figsize=(6, 5))
sns.heatmap(cm_train, annot=True, fmt="d", cmap="Blues", xticklabels=["Anger", "Fear", "Joy"], 
            yticklabels=["Anger", "Fear", "Joy"])
...
plt.figure(figsize=(6, 5))
sns.heatmap(cm_test, annot=True, fmt="d", cmap="Blues", xticklabels=["Anger", "Fear", "Joy"], 
            yticklabels=["Anger", "Fear", "Joy"])
